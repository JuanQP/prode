# Generated by Django 3.2.16 on 2022-12-17 17:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team_a_score', models.CharField(blank=True, default='', max_length=2)),
                ('team_b_score', models.CharField(blank=True, default='', max_length=2)),
                ('datetime', models.DateTimeField(default=django.utils.timezone.now)),
                ('stadium', models.CharField(max_length=50)),
                ('status', models.CharField(choices=[('Pendiente', 'Pending'), ('Finalizado', 'Finished')], default='Pendiente', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('short_name', models.CharField(blank=True, default='', max_length=4)),
        ...
        migrations.AddField(
            model_name='match',
            name='team_a',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='app.team'),
        ),
        migrations.AddField(
            model_name='match',
            name='team_b',
